...
(function(){
  ...
  const DICTS = {
    ...
    da: {
      ...
      OTP_SUBTITLE   : 'Klik nedenfor for at modtage en 6-cifret bekræftelseskode via SMS.',
      OTP_RESEND_BTN : 'Send SMS Kode',
      ...
      /* OTP fallbacks (server may return j.error; these are our safe defaults) */
      ...
      /* FAQ */
      FAQ_BTN       : 'Oftest stillede spørgsmål',
    ...
    sv: {
      ...
      HEADER_ALL_OK_SHORT     : 'Godkänt',

      /* OTP */
      OTP_TITLE      : 'Bekräfta din identitet',
      OTP_SUBTITLE   : 'Klicka nedan för att få en 6-siffrig verifieringskod via SMS.',
      OTP_RESEND_BTN : 'Skicka SMS Kod',
    ...
    en: {
      ...
      OTP_SUBTITLE   : 'Click below to receive a 6-digit verification code on SMS.',
      OTP_RESEND_BTN : 'Send SMS Code',
      ...
      FAQ_SECTION1_BODY : `
        ...
        <div class="faq-block">
          ...
          <p>The total forced share is 25%. The figure <strong>6.25%</strong> can arise in a scenario with a <em>spouse (12.5%) and two children</em> who split 12.5% = <strong>6.25% per child</strong>. Percentages differ with more/fewer children or no spouse.</p>
        </div>
