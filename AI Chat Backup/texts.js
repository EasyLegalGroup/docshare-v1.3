...
(function(){
  ...
  const DICTS = {
    ...
    da: {
      ...
      BLOCKED_APPROVAL_BODY   : 'Din jurist har deaktiveret muligheden for at godkende dette dokument, da der stadig mangler nogle oplysninger, før du kan indsende din endelige godkendelse. Hvis du stadig er i tvivl om, hvad der mangler, efter at have læst dit dokument igennem, bedes du bruge chatten i højre side til at kontakte os.',
  ...
  JOURNAL_FIRST_DRAFT_SENT: {
    ...
    sv: {
      ...
      BLOCKED_APPROVAL_BODY   : 'Din jurist har inaktiverat möjligheten att godkänna detta dokument eftersom viss information fortfarande krävs innan du kan skicka in ditt slutliga godkännande. Om du fortfarande är osäker på vad som saknas efter att ha läst igenom ditt dokument, använd chatten på höger sida för att kontakta oss.',
