...
(function(){
  ...
  const DICTS = {
    ...
    da: {
      ...
      BLOCKED_APPROVAL_BODY   : 'Din advokat har deaktiveret muligheden for at godkende dette dokument, da der stadig mangler nogle oplysninger, før du kan indsende din endelige godkendelse. Hvis du stadig er i tvivl om, hvad der mangler, efter at have læst dit dokument igennem, bedes du bruge chatten i højre side til at kontakte os.',
      APPROVAL_BLOCKED_HINT   : 'Godkendelse er blokeret af din advokat',
      CLOSE                   : 'Luk',
  ...
  JOURNAL_FIRST_DRAFT_SENT: {
    ...
    sv: {
      ...
      /* blockerad godkännande */
      BLOCKED_APPROVAL_HEADER : 'Dokumentet kan inte godkännas',
      BLOCKED_APPROVAL_BODY   : 'Din advokat har inaktiverat möjligheten att godkänna detta dokument eftersom viss information fortfarande saknas innan du kan skicka in ditt slutliga godkännande. Om du fortfarande är osäker på vad som saknas efter att ha läst igenom ditt dokument, använd chatten på höger sida för att kontakta oss.',
      APPROVAL_BLOCKED_HINT   : 'Godkännande är blockerat av din advokat',
      CLOSE                   : 'Stäng',
