    ...
    try:
        ...
        for doc_id in ids:
            try:
                ...
                if sess.get("typ") == "email":
                    soql = (
                        "SELECT Id, Is_Approval_Blocked__c, Journal__r.Account__r.PersonEmail, Journal__r.Account__r.Spouse_Email__pc, "
                    ...
                    soql = (
                        "SELECT Id, Is_Approval_Blocked__c, Journal__r.Account__r.Phone_Formatted__c, Journal__r.Account__r.Spouse_Phone__pc, "
                        "       Journal__r.Account__r.Is_Spouse_Shared_Document_Recipient__pc "
                        "FROM Shared_Document__c "
                        "WHERE Id = '" + safe_id + "' LIMIT 1"
                    )
